      ...
      <div className="w-full max-w-lg">
        <Card className="glass-strong border-2 border-[#7c3aed]/35">
          <CardHeader className="space-y-4">
            ...
            <CardTitle className="text-4xl font-extrabold text-white text-center tracking-tight">Access {APP_NAME}</CardTitle>
            ...
            <form onSubmit={handleLogin} className="space-y-7">
              ...
              <div className="text-center pt-2">
                <p className="text-base text-[#e9d5ff]/80">
                  New user?{" "}
                  <Link href="/auth/sign-up" className="text-[#84cc16] hover:text-[#bef264] font-bold transition-colors">
                    Create Account
                  </Link>
                </p>
              </div>
