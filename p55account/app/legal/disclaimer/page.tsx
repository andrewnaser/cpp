        ...
        <Card className="glass-strong border-border/50">
          ...
          <CardContent className="prose prose-invert max-w-none space-y-6">
            ...
            <section className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                {APP_NAME} is designed to help you find trending Shorts and generate comment packs. You are responsible
            ...
            <section className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                The typical user of {APP_NAME} may not achieve any specific results. Success depends on consistency,
